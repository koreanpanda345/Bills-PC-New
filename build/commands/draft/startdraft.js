...
exports.StartdraftCommand = void 0;
const draft_1 = require("../../monitors/draft");
class StartdraftCommand {
    constructor() {
        this.name = "startdraft";
        this.category = "draft";
        this.description = "Starts the draft.";
        this.permission = {
            user: ["MANAGE_GUILD"]
        };
        this.invoke = async (ctx) => {
            let draft = new draft_1.DraftMonitor(ctx);
...
exports.StartdraftCommand = StartdraftCommand;
